...
stoffwechsel <- stoffwechsel %>%
  pivot_longer(cols = Fett:Kohlenhydrate, names_to = "Nährstoff", values_to = "Menge")
...
stoffwechsel %>%
  ...
  scale_y_continuous(limits=c(0, 200), breaks=seq(0, 200, 50), labels = label_number(suffix = " g")) +
